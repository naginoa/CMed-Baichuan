...
if __name__ == '__main__':
    train_data_lines = []
    chip_train_datafile = '../chip/train.json'
    for line in read_json_file(chip_train_datafile):
        line = json.loads(line)
        task_dataset = line['task_dataset']
        aug_prompt = prompt_dict[task_dataset]
        line['instruction'] = aug_prompt
        train_data_lines.append(line)
    print(len(train_data_lines))

    print(get_json_file_list('./'))
    for aug_file in get_json_file_list('./'):
        print(aug_file)
        if 'process' in aug_file:
            aug_prompt = aug_file.split('_')[1]
            aug_prompt = aug_prompt.split('.')[0]
            # print(aug_prompt)
            aug_prompt = prompt_dict[aug_prompt]
            # print(aug_prompt)
        else:
            aug_prompt = aug_file.split('_')[0]
            aug_prompt = aug_prompt.split('/')[1]
            # print(aug_prompt)
            aug_prompt = prompt_dict[aug_prompt]
            # print(aug_prompt)

        for line in read_json_file(aug_file):
            line = json.loads(line)
            line['instruction'] = aug_prompt
            train_data_lines.append(line)
    ...
    with open('../chip/train_aug_prompt3.json', 'w') as f:
    ...
    with open("../../../data/chip2023_train_aug_prompt3.json", "w") as f:
