        ...
        for line in f:
            ...
            if task_dataset == "CMeEE-V2":
                ...
                for ans_str in list_answer_strs:
                    ...
                    if "头实体：" not in ans_str:
                        continue
                    head_ent = ans_str.split("头实体：")[1].split("；尾实体：")[0]
                    if rel != "条件关系":
                        if '；尾实体：' not in ans_str:
                            continue
