...
if __name__ == "__main__":
    ...
    # standard_path = '../../../../data/chip2023/baichuan13b-chat-chip2023-lr2e4-bs4-grad4/pred-ckp10250-pred/results.json'
    standard_path = '../../../data/CHIP2023/chip/dev_structured.json'
    # B_test
    # standard_path = '../../../../data/CHIP2023/prompt3-baichuan13b-chat-chip2023-lr2e4-bs1-grad16/pred-ckp11000-predB/results.json'
